...
charlist = charlist['Unicode'].tolist()
...
for book in testlist:
    ...
    #GT
    #if book in testlist:
    gt = pd.read_csv(datapath + book + "/" + book + "_coordinate.csv")
    size = pd.read_csv(datapath + book + "/" + "imagesize.csv")
